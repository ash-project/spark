defmodule Spark.Dsl do
    ...
    generator: [
      ...
      keys: [
        ...
        includes_otp_app?: [
          type: :boolean,
          doc:
            "Wether or not to pass the otp app in the opts when generating an instance of this."
        ],
        create_options: [
          type: :keyword_list,
          default: [],
        ...
        owned_by: [
          # Something weird with this leaves it as an alias?
          type: :any,
          doc: "What other spark `owns` this dsl from a generator perspective"
        ],
        child_path: [
          type: :string,
          doc:
            "The path relative to the parent that this should be generated into, if it is owned_by something"
        ]
      ]
    ]
  ]
  ...
  defmacro __using__(opts) do
    ...
    quote bind_quoted: [
      ...
      @doc false
      def generator_name, do: unquote(parent_opts[:generator][:name])
      @doc false
      def generator_includes_otp_app?, do: unquote(parent_opts[:generator][:includes_otp_app?])
      @doc false
      def create_options, do: unquote(parent_opts[:generator][:create_options])
